...
FIRMWARE_ADSP_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FIRMWARE_FIRMWARE_MODEM_IMAGES)))
...
FIRMWARE_CMN_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FIRMWARE_CMN_IMAGES)))
$(FIRMWARE_CMN_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "CMN firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_CMN_SYMLINKS)
...
FIRMWARE_SMPLAP_IMAGES := \
    smplap32.b00 smplap32.b01 smplap32.b02 smplap32.b03 smplap32.b04 smplap32.b05 \
    smplap32.b06 smplap32.mdt

FIRMWARE_SMPLAP_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FIRMWARE_SMPLAP_IMAGES)))
$(FIRMWARE_SMPLAP_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "SMPLAP firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_SMPLAP_SYMLINKS)

FIRMWARE_SYNAFP_IMAGES := \
    synafp64.b00 synafp64.b01 synafp64.b02 synafp64.b03 synafp64.b04 synafp64.b05 \
    synafp64.b06 synafp64.mdt

FIRMWARE_SYNAFP_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FIRMWARE_SYNAFP_IMAGES)))
$(FIRMWARE_SYNAFP_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "SYNAFP firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_SYNAFP_SYMLINKS)
...
ALL_DEFAULT_INSTALLED_MODULES += $(WCNSS_INI_SYMLINK) $(FIRMWARE_WCNSS_SYMLINKS)

FIRMWARE_WV_IMAGES := \
    widevine.b00 widevine.b01 widevine.b02 widevine.b03 widevine.b04 widevine.b05 \
    widevine.b06 widevine.mdt

FIRMWARE_WV_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FIRMWARE_WV_IMAGES)))
$(FIRMWARE_WV_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Widevine firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_WV_SYMLINKS)
